...
var _defaultIndexer = function(item, options) {
  ...
  if (typeof item._source.measurements !== 'undefined'
    && typeof item._source.measurements.volumen_maletero_principal !== 'undefined') {
      item._source.measurements.volumen_total_de_maleteros = item._source.measurements.volumen_maletero_principal;
  }
